...
public class RisultatoDTO<T> implements Serializable{
    ...
    @ApiModelProperty(required=true, notes="successo", position=1)
    ...
    @ApiModelProperty(notes="Eventuale payload di risposta", position=4)
    protected T data;

    @ApiModelProperty(notes="Eventuale payload di risposta", position=5)
